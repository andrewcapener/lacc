...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: BASE_URL + '/services/check-cashing/', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: BASE_URL + '/services/moneygram-money-transfers/', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: BASE_URL + '/services/money-orders/', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: BASE_URL + '/services/notary-services/', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: BASE_URL + '/services/prepaid-cards/', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: BASE_URL + '/cambio-de-cheques/', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
