  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-extrabold text-gray-900 mb-4">La Cienega Check Cashing</h1>
        <p className="text-xl text-gray-600 mb-10">Conveniently located on W. 3rd Street in Los Angeles near La Cienega Blvd.</p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">8506 W. 3rd Street<br />Los Angeles, CA 90048</p>
          ...
          <div>
            <div className="rounded-lg overflow-hidden border border-gray-200 h-72 mb-6">
              <iframe
                ...
                title="La Cienega Check Cashing Map"
              />
            </div>
